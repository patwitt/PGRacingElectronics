...
typedef enum {
	...
	CAN_RX_MSG_GEAR_MODE = 0x03U,
	CAN_RX_MSG_SAFETY_CUT_1 = 0x04,
	CAN_RX_MSG_SAFETY_CUT_2 = 0x05,
	CAN_RX_MSG_COUNT     = 0x06
} CAN_RxMsgEnum;
...
typedef enum {
	...
	CAN_RX_MSG_STDID_GEAR_MODE = 0x50U,
	CAN_RX_MSG_STDID_SAFETY_CUT_1 = 0x90,
	CAN_RX_MSG_STDID_SAFETY_CUT_2 = 0x91,
	CAN_RX_MSG_STDID_COUNT     = 0x04U
} CAN_RxMsgsStdIdEnum;
