...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA3     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = GEAR_SENS_Pin|IS_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(GPIOA, GEAR_SENS_Pin|IS_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB1     ------> ADC2_IN9
    */
    HAL_GPIO_DeInit(GPIOA, TPS_1_Pin|TPS_2_Pin);

    HAL_GPIO_DeInit(APPS_1_GPIO_Port, APPS_1_Pin);

    HAL_GPIO_DeInit(APPS_2_GPIO_Port, APPS_2_Pin);
