...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(MLX2_SCL_GPIO_Port, MLX2_SCL_Pin);

    HAL_GPIO_DeInit(MLX2_SDA_GPIO_Port, MLX2_SDA_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(MLX1_SDA_GPIO_Port, MLX1_SDA_Pin);

    HAL_GPIO_DeInit(MLX1_SCL_GPIO_Port, MLX1_SCL_Pin);
